...
function App() {
  ...
  return (
    ...
    <>
      <div className='App'>
        <h2 style={{ textAlign: 'center', color: 'indigo', }}>TypeScript Props Component</h2>
        ...
        <Card Name="Hammad" fatherName='Abid Hussain' isApproved='true' Learning='Mern Stack' phone="03353259657"/>
        <Tabel   cols={[
        {
          heading:"Rollno",
          key:"rollno"
